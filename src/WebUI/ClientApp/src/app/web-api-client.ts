...
export interface IAnnouncementClient {
    getAllAnnouncements(): Observable<Announcement[]>;
    create(command: CreateAnnouncementCommand): Observable<number>;
}

@Injectable({
    providedIn: 'root'
})
export class AnnouncementClient implements IAnnouncementClient {
    ...
    getAllAnnouncements() : Observable<Announcement[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllAnnouncements(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllAnnouncements(<any>response_);
                } catch (e) {
    ...
    protected processGetAllAnnouncements(response: HttpResponseBase): Observable<Announcement[]> {
...
export class Announcement implements IAnnouncement {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.announcementCategory = _data["announcementCategory"];
    ...
    toJSON(data?: any) {
        ...
        data["announcementCategory"] = this.announcementCategory;
